            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input value="{{ old('posicao',$servico->posicao ?? '' )}}" type="input" required class="form-control" name="posicao" data-mask="00" id="posicao"  placeholder="Posição do serviço na plataforma">
                    </div>
                </div>
            </div>
        </fieldset>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input value="{{ old('valor_minimo', $servico->valor_minimo ?? '' )}}" type="input" required class="form-control" name="valor_minimo" data-mask="#.##0,00" data-mask-reverse="true" id="valor_minimo"  placeholder="Valor mínimo do serviço">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ old('valor_banheiro', $servico->valor_banheiro ?? '' )}}" type="input" required class="form-control" name="valor_banheiro" data-mask="#.##0,00" data-mask-reverse="true" id="valor_banheiro"  placeholder="Valor por banheiro">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ old('valor_cozinha', $servico->valor_cozinha ?? '' )}}" type="input" required class="form-control" name="valor_cozinha" data-mask="#.##0,00" data-mask-reverse="true" id="valor_cozinha"  placeholder="Valor por cozinha">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ old('valor_quintal', $servico->valor_quintal ?? '' )}}" type="input" required class="form-control" name="valor_quintal" data-mask="#.##0,00" data-mask-reverse="true" id="valor_quintal"  placeholder="Valor por quintal">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ old('valor_outros', $servico->valor_outros ?? '' )}}" type="input" required class="form-control" name="valor_outros" data-mask="#.##0,00" data-mask-reverse="true" id="valor_outros"  placeholder="Valor por outros">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
